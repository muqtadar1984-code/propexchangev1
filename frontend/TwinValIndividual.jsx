...
const S = {
  ...
  tab:          { padding: "8px 18px", cursor: "pointer", fontSize: 13, color: "#8a8070", borderBottom: "2px solid transparent", background: "none", border: "none", color: "#a8a090" },
  tabActive:    { padding: "8px 18px", cursor: "pointer", fontSize: 13, color: "#C9A84C", borderBottom: "2px solid #C9A84C", background: "none", border: "none", borderBottom: "2px solid #C9A84C", color: "#C9A84C" },
